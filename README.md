<!--
**RafaLopezZz/RafaLopezZz** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
Desarrollador **Fullstack** con foco creciente en **Backend Java + Cloud**, orientado a construir software útil, mantenible y con impacto real en operación.

Trabajo con stacks como **Java/Spring Boot, PHP/Laravel, Angular, TypeScript, SQL y Docker**, y me interesa especialmente el software aplicado a **negocio, automatización, datos, IoT y sistemas operativos reales**.
